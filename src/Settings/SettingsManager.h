...
#endif
    Q_MOC_INCLUDE("AirDataSettings.h")
...
#endif
    Q_PROPERTY(QObject *airDataSettings                 READ airDataSettings                CONSTANT)
...
#endif
    AirDataSettings *airDataSettings() const;
...
#endif
    AirDataSettings *_airDataSettings = nullptr;
