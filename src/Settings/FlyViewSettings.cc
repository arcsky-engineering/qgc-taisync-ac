...
DECLARE_SETTINGSFACT(FlyViewSettings, payloadMavlinkCamType)
DECLARE_SETTINGSFACT(FlyViewSettings, payloadMavlinkCamBaud)
DECLARE_SETTINGSFACT(FlyViewSettings, payloadSelection)
DECLARE_SETTINGSFACT(FlyViewSettings, tapToFocusEnabled)
DECLARE_SETTINGSFACT(FlyViewSettings, tapToFocusSpotMode)
DECLARE_SETTINGSFACT(FlyViewSettings, tapToFocusInsetX)
DECLARE_SETTINGSFACT(FlyViewSettings, tapToFocusInsetY)
